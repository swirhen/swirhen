...
docker run --name tiarra --add-host=myhost:host-gateway --network host -d --rm -v /home/swirhen/tiarra/:/tiarra/ -v /var/www/tm/:/var/www/tm/ perl-tiarra /bin/sh -c '/tiarra/tiarra --config=/tiarra/tiarra.conf' > docker.id
